	...
	if( $_POST['t_name']==''||
	...
	else
		{
			...
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
						<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				        <strong>Congrass!</strong> New Task Added Successfully.
						</div>';
	   }
}
...
<head>
    ...
    <title>Add Task For Janitor</title>
    <!-- Bootstrap Core CSS -->
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Task for Employee</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="e_name" class="form-control custom-select" data-placeholder="Choose Employee" tabindex="1">
                                                        <option>--Select Employee--</option>
                                                    <?php 
                                                        $ssql ="SELECT * FROM (task_type
                                                            INNER JOIN jobs ON task_type.job_id = jobs.job_id)
                                                            INNER JOIN users ON task_type.job_id = users.job_id";
                                                        $res = mysqli_query($db, $ssql);
                                                        while($row = mysqli_fetch_array($res))
                                                        {
                                                            echo' <option value="'.$row['u_id'].'"> '.$row['f_name'].' '.$row['l_name'].'; '.$row['job_name'].'</option>';
                                                        }
                                                    ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="t_name" class="form-control custom-select" data-placeholder="Choose Task" tabindex="1">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date" class="form-control form-control-danger" placeholder="dd/mm/yyyy">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <select name="area" class="form-control custom-select" data-placeholder="Choose Area" tabindex="1">
                                                        ...
                                                        <option value="HMon">Huyện Hóc Môn</option>
                                                        <option value="BThanh">Huyện Bình Thạnh</option> 
														<option value="Btan">Huyện Bình Tân</option>
														<option value="TBinh">Huyện Tân Bình</option>
														<option value="TDuc">Huyện Thủ Đức</option>
														<option value="BChanh">Huyện Bình Chánh</option>
                                                        <option value="NBe">Huyện Nhà Bè</option>
                                                    </select>  
                                                </div>                                                  </div>
                                            </div>
                                            <!--/span-->
