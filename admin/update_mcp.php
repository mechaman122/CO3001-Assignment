...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	else
		{
            ...
            elseif(strlen($_POST['phone']) < 10)
            {
                ...
                $sql = "UPDATE mcps set mcp_name='$_POST[mcp_name]', email='$_POST[email]', phone='$_POST[phone]', o_hr='$_POST[o_hr]', c_hr='$_POST[c_hr]', o_days='$_POST[o_days]', status='$_POST[status]', address='$_POST[address]'
                where mcp_id='$_GET[mcp_upd]' ";
                mysqli_query($db, $sql);
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update MCP</h4>
                            
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from mcps where mcp_id='$_GET[mcp_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mcp_name" value="<?php echo $row['mcp_name'];  ?>" class="form-control" placeholder="MCP Name">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="0123456789">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_hr" class="form-control custom-select"   data-placeholder="Choose Open Hour" >
                                                     <option><?php echo $row['o_hr'];  ?></option>
                                            ...
                                            <!--/span-->
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_hr" class="form-control custom-select"    data-placeholder="Choose Close Hour" >
                                                     <option><?php echo $row['c_hr'];  ?></option>
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select"  data-placeholder="Choose a Category" tabindex="1">
                                                        <option><?php echo $row['o_days'];  ?></option>
