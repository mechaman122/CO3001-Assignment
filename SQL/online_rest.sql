...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 02, 2022 lúc 01:30 PM
...
-- Thủ tục
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `use_ranking` ()   BEGIN
	SELECT * ,rank()
	OVER ( partition by users.user_job order by users.task_complete desc ) 
	FROM users;
end$$
...
INSERT INTO `users` (`u_id`, `username`, `f_name`, `l_name`, `email`, `phone`, `password`, `address`, `status`, `date`, `user_job`, `task_complete`, `img`) VALUES
(31, 'navjot789', 'navjot', 'singh', 'ns949405@gmail.com', '9041240385', '6d0361d5777656072438f6e314a852bc', 'badri col phase 2', 1, '2022-12-02 02:28:59', 'Janitor', 5, ''),
(32, 'navjot890', 'nav', 'singh', 'nds949405@gmail.com', '6232125458', '6d0361d5777656072438f6e314a852bc', 'badri col phase 1', 1, '2022-12-02 02:28:59', 'Collector', 7, ''),
(33, 'khoa', 'khoa', 'khoa', 'dangkhoa0521@gmail.com', '0909617574', 'e10adc3949ba59abbe56e057f20f883e', '', 1, '2022-12-02 02:28:59', 'Collector', 9, '');
