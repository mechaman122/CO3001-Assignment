            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All MCPs data</h4>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM mcps where mcp_id='".$rows['mcp_id']."'";
																					...
																					echo ' <tr>
																								...
																								<td>'.$rows['address'].'</td>
																									 ...
																									 <td><a href="delete_mcp.php?mcp_del='.$rows['mcp_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_mcp.php?mcp_upd='.$rows['mcp_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
