    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper" style="height:1200px;">
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-industry f-s-40 color-warning"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from mcps";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0">MCPs</p>
                                </div>
                            </div>
                        </div>
                    </div>
					 ...
					 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-calendar-o f-s-40" aria-hidden="true"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from task";
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
            ...
            <div id="map-container-google-1" class="z-depth-1-half map-container" style="height: 200px">
                <iframe src="https://maps.google.com/maps?q=hochiminh&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
