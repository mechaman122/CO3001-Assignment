...
if(isset($_POST['submit'] ))
{
	...
	$mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,job_id) VALUES('".$_POST['uname']."','".$_POST['fname']."','".$_POST['lname']."','".$_POST['email']."','".$_POST['phone']."','".md5($_POST['password'])."','".$_POST['address']."','".$_POST['job_name']."')";
	mysqli_query($db, $mql);
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="fname" class="form-control form-control-danger" placeholder="Trinh">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lname" class="form-control" placeholder="Khoa">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <select name="job_name" class="form-control custom-select" data-placeholder="Choose a Job" >
