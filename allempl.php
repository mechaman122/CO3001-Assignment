													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
																	while($rows=mysqli_fetch_array($query))
																		{   $mql="SELECT * from jobs  where job_id = '".$rows['job_id']."'";
                                                                            ...
                                                                            $fetch=mysqli_fetch_array($newquery);
																					...
																					echo ' <tr><td>'.$rows['username'].'</td>
																								...
																								<td>'.$rows['date'].'</td>
																									 ...
																									 <td><a href="delete_empl.php?user_del='.$rows['u_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_empl.php?user_upd='.$rows['u_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																									</td></tr>';
