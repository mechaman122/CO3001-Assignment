            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Vehicles data</h4>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr>
																					           <td>'.$rows['License_plates'].'</td>
                                                                                                ...
                                                                                                <td><a href="delete_vehicle.php?vehicle_del='.$rows['License_plates'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								</tr>';
