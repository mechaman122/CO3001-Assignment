...
if(isset($_POST['submit']))           //if upload btn is pressed
{
	...
	if( empty($_POST['job_name'])||
		...
		{       
												...
												$sql = "INSERT INTO task_type (job_id, task_name, description) VALUE('".$_POST['job_name']."','".$_POST['t_name']."','".$_POST['Jd']."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Congrass!</strong> New Task Created Successfully.
															</div>';
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Create new Task</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
											<div class="col-md-12">
                                                <div class="form-group">
													...
													<select name="job_name" class="form-control custom-select" data-placeholder="Choose a Job" tabindex="1">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="t_name" class="form-control" placeholder="Name of Task">
                                                   </div>
                                            </div>
                                        ...
                                        <!--/row-->
                                        <div>
                                            <h3 class="box-title m-t-40"> Job Description</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    
                                                    <textarea name="Jd" type="text" style="height:100px;" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>         
