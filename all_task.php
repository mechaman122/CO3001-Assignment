            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
						     ...
						     <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">All Task data</h4>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM task order by u_id desc";
													...
													if(!mysqli_num_rows($query) > 0 )
														...
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="SELECT * from (users INNER JOIN jobs on users.job_id = jobs.job_id) INNER JOIN task_type on users.job_id = task_type.job_id where u_id='".$rows['u_id']."'";
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr>  <td>'.$fetch['username'].'</td>
																								...
																								<td>'.$fetch['job_name'].'</td>
																								<td>'.$fetch['task_name'].'</td>
																								<td>'.$rows['date'].'</td>
																								<td>'.$rows['area'].'</td>
                                                                                                <td>'.$rows['status'].'</td>
																								
																							
																									 <td><a href="delete_task.php?task_del='.$rows['task_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									</td></tr>';
